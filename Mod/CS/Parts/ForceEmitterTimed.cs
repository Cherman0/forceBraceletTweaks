...
namespace XRL.World.Parts {
	...
	[Serializable]
	public class Cherman0_ForceBraceletTweaks_ForceEmitterTimed : IPoweredPart
	{
		...
		public Cherman0_ForceBraceletTweaks_ForceEmitterTimed()
		{
			ChargeUse = 500;
		...
		public string GetActivatedAbilityName(GameObject Actor = null)
		{
			...
			stringBuilder.Append((Actor == null || Actor == ParentObject) ? "Force Emitter" : Grammar.MakeTitleCase(ParentObject.BaseDisplayNameStripped));
